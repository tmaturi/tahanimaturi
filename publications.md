...
- X. Huang, F.P.A. Coolen, **T. Coolen-Maturi**, Y. Zhang (2020). A new study on reliability importance analysis of phased mission systems. IEEE Transactions on Reliability,  69(2), 522-532. [[preprint version](pdfs/Reliability_importance_analysis_of_phased_mission_system.pdf){:target="_blank"}]
